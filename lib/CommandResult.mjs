...
export default class CommandResult 
{
    ...
    /**
     * Returns whether this command result is an usage error or not.
     * 
     * @return {boolean} True if this result is an usage error, else false.
     */
    is_usage_error() {
        return this.id.equals(CommandResult.ERROR_USAGE.id);
    }
}

CommandResult.translate_callback = (ctx, id) => id.toString();
